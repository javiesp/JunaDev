...
/* harmony import */ var notiflix__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! notiflix */ 6977);
...
let RestaurantesPage = class RestaurantesPage {
  ...
  agregarAlCarrito(usuarioID, plato, restaurante) {
    ...
    notiflix__WEBPACK_IMPORTED_MODULE_3__.Notify.success('Agregado al carrito');
  ...
  getItems(event) {
    ...
    if (terminoBusqueda && terminoBusqueda.trim() !== '') {
      this.restaurantesFiltrados = this.restaurantes.filter(restaurante => restaurante.nombre && restaurante.nombre.toLowerCase().includes(terminoBusqueda));
    } else {
...
RestaurantesPage = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
